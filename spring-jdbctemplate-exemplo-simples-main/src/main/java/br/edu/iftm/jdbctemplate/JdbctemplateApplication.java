...
public class JdbctemplateApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		System.out.println("O numero de registros da tabela contatos é " + rowCount);
		String telefone = this.jdbcTemplate.queryForObject("select telefone from contatos where nome = ?", String.class, "Edson Angoti Júnior");
